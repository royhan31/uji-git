                ...
                <div class="authentication-box">
                  ...
                  <div class="card mt-4 p-4">
                    <div class="card-body">
                      ...
                      <form class="theme-form" method="post" action="{{route('admin.get.login')}}">
                        @csrf
                        <div class="form-group">
                          <label class="col-form-label pt-0">Username</label>
                          <input type="text" class="form-control @error('username') is-invalid @enderror" name="username" value="{{ old('username') }}" required autofocus placeholder="Masukan Username">
                          @error('username')
