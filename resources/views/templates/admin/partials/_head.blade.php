<head>
  ...
  <title>@if(Request::is('admin/login')) LokerIT - Login
    @else LokerIT - Admin
     @endif</title>
  <!-- Google font-->
  ...
  <!-- Font Awesome-->
  <link rel="stylesheet" type="text/css" href="{{ asset('assets/back/css/fontawesome.css')}}">
  <!-- ico-font-->
  <link rel="stylesheet" type="text/css" href="{{ asset('assets/back/css/icofont.css')}}">
  <!-- Themify icon-->
  <link rel="stylesheet" type="text/css" href="{{ asset('assets/back/css/themify.css')}}">
  <!-- Flag icon-->
  <link rel="stylesheet" type="text/css" href="{{ asset('assets/back/css/flag-icon.css')}}">
  <!-- Feather icon-->
